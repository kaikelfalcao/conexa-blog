...
return array (
  ...
  'Delete' => 'Ta bort',
  'Displaying {start}-{end} of 1 result.|Displaying {start}-{end} of {count} results.' => 'Visar {start}-{end} av totalt 1 posts.|Visar {start}-{end} av totalt {count} poster.',
  ...
  'Total 1 result.|Total {count} results.' => 'Totalt 1 posts.|Totalt {count} poster.',
  'Update' => 'Uppdatera',
  'View' => 'Visa',
