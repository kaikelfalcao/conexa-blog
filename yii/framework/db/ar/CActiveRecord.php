...
abstract class CActiveRecord extends CModel
{
	 ...
	 * queries:
	 * <pre>
	 * $post=Post::model()->published()->findAll();
	 * $post=Post::model()->published()->recently()->findAll();
	 * $post=Post::model()->published()->with('comments')->findAll();
	 * </pre>
	 ...
	 * <pre>
	 * // find all post together with their author and comments
	 * Post::model()->with('author','comments')->findAll();
	 * // find all post together with their author and the author's profile
